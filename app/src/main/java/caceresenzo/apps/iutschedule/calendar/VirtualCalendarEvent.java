...
public class VirtualCalendarEvent implements Serializable, WeekViewDisplayable<VirtualCalendarEvent> {
	...
	public static final class Builder implements IBuilder<VirtualCalendarEvent> {
		 ...
		 * Set a start date.
		 *
		 * @param date Start {@link VirtualCalendarDate date}.
		 ...
		 * Set a end date.
		 *
		 * @param date End {@link VirtualCalendarDate date}.
		 * @return <code>this</code> for method chaining (fluent API).
		 */
		 ...
		 *
		 * @param location Event's location (usually room where it will be taking place).
		 * @return <code>this</code> for method chaining (fluent API).
		 */
		 ...
		 *
		 * @param description Event's description (usually more information about the event like the teacher).
		 * @return <code>this</code> for method chaining (fluent API).
		 */
		 ...
		 *
		 * @return <code>this</code> for method chaining (fluent API).
		 * @throws NullPointerException If the {@link #describe(String) description} is <code>null</code>.
		 ...
		 *
		 * @param uid Event's unique identifier.
		 * @return <code>this</code> for method chaining (fluent API).
		 */
